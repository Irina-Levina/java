...
public class MertoLine implements Comparable<MertoLine> {
    ...
    public MertoLine(String name, String number) {
        this.name = name;
        this.number = number;
    ...
    @Override
    public int compareTo(MertoLine mertoLine) {

        int isOneLine = this.getNumber().compareTo(mertoLine.getNumber());
